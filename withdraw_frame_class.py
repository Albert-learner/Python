...
class WithdrawFrame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, parent=None, title="출금")
        ...
        self.moneyStatic = wx.StaticText(self.mainPanel, label="출금액 ")
        ...
        self.btn = wx.Button(self.mainPanel, label='출금')
